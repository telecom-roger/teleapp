...
export const ecommerceOrderRequestedDocuments = pgTable(
  "ecommerce_order_requested_documents",
  {
    id: varchar("id")
      .primaryKey()
      .default(sql`gen_random_uuid()`),
...
export const insertEcommerceOrderRequestedDocumentSchema = createInsertSchema(
...
export type EcommerceOrderRequestedDocument =
  typeof ecommerceOrderRequestedDocuments.$inferSelect;
export type InsertEcommerceOrderRequestedDocument = z.infer<
  typeof insertEcommerceOrderRequestedDocumentSchema
>;
...
export const ecommerceOrderLines = pgTable(
  "ecommerce_order_lines",
  {
    ...
    productId: varchar("product_id")
      .notNull()
      .references(() => ecommerceProducts.id), // Plano contratado para esta linha
    ...
    svas: text("svas")
      .array()
      .default(sql`ARRAY[]::text[]`), // IDs dos SVAs selecionados para esta linha
...
export const insertEcommerceOrderLineSchema = createInsertSchema(
  ecommerceOrderLines
).omit({
  id: true,
  createdAt: true,
