...
export default function CampanhasWhatsApp() {
  ...
  // Fetch campanhas para filtro (igual a campanhas-agendadas)
  ...
  useEffect(() => {
    if (
      ...
      selectedEngajamentoFilter.size > 0 ||
      selectedEtiquetaFilter.size > 0 ||
      dataEnvioInicio ||
      dataEnvioFim ||
      limitPerPage !== 50
    ) {
  ...
  }, [searchClientes, filtroStatus, selectedTag, selectedTiposFilter, selectedCarteirasFilter, selectedCidadesFilter, selectedSendStatusFilter, selectedCampaignFilter, selectedEngajamentoFilter, selectedEtiquetaFilter, dataEnvioInicio, dataEnvioFim, limitPerPage]);
